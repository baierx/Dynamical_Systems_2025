...
# # Bistability through Forward Inhibition
# 
# Forward inhibition induces a new feature in open flow setting, namely, bistability. In an open flow setting, the lower and the upper state of the sigmoidal Hill function can now overlap and co-exist in the same situation. Example: ATP kinetics of the PFK1 reaction. This allows switching between states by external regulatory processes. Concept: numerical simulations of the bifurcation diagram and “potential”.
...
# ## Model of Feedforward inhibition in Open Flow
# 
...
# ## Nonlinear Functions with Sliders
