...
if __name__ == "__main__":
    ...
    h_ex_values, Ex_extrema, In_1_extrema, In_2_extrema = create_bifurcation_diagram(
    # h_ex_vals, Ex_mins, Ex_maxs, In_1_mins, In_1_maxs = create_bifurcation_diagram(
        [h_ex_min, h_ex_max],
        dX_dt,
        initial_conditions,
        n_points=n_points,
    ...
    # Plot
    fig = plot_bifurcation_diagram(h_ex_values, Ex_extrema, In_1_extrema, In_2_extrema,
